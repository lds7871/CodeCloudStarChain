      ...
      return i(e, [{
        ...
        value: function (e) {
          if (this.player.events.trigger("listswitch", {
            ...
            pyj.scrollLyricToTop();
            // 添加歌词点击事件
            pyj.addLyricClickEvent();
            ...
            if (t.cover) {
              ...
              img.src = t.cover;
              img.onload = function() {
                  pyj.updateThemeColorWithImage(img);
              };
          }
          }
        }
      ...
      return a(e, [{
        ...
        value: function () {
          ...
          if (this.index > this.current.length - 1 || e < this.current[this.index][0] || !this.current[this.index + 1] || e >= this.current[this.index + 1][0])
            for (var t = 0; t < this.current.length; t++) e >= this.current[t][0] && (!this.current[t + 1] || e < this.current[t + 1][0]) && (this.index = t, this.container.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"), this.container.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current"), pyj.scrollLyric())
        }
      }, {
        key: "switch",
        value: function (e) {
      ...
      g = function () {
        ...
        return i(e, [{
          ...
          value: function () {
            ...
            document.getElementById('Music-page').classList.add('aplayer_playing');
          }
        }, {
          key: "setUIPaused",
          value: function () {
          ...
          key: "pause",
          value: function () {
            this.setUIPaused(), this.audio.pause(), document.getElementById('Music-page').classList.remove('aplayer_playing');
          }
        }, {
