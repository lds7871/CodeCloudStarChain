!function (t, e) {
    ...
    var s, r = function (t) {
        ...
        function t(t, e, i, s) {
            return this.x = t, this.y = e, this.width = i, this.height = s, this.top = this.y, this.left = this.x, this.bottom = this.top + this.height, this.right = this.left + this.width, r(this)
        }
        ...
        if (a(t)) {
            var e = t.getBBox(), i = e.width, s = e.height;
            return !i && !s
        }
        var r = t, n = r.offsetWidth, o = r.offsetHeight;
    ...
    }, l = "undefined" != typeof window ? window : {}, u = new WeakMap, d = /auto|scroll/, g = /^tb|vertical/,
        W = /msie|trident/i.test(l.navigator && l.navigator.userAgent), p = function (t) {
            return parseFloat(t || "0")
        }, m = function (t, e, i) {
            return void 0 === t && (t = 0), void 0 === e && (e = 0), void 0 === i && (i = !1), new n((i ? e : t) || 0, (i ? t : e) || 0)
        }, C = r({ devicePixelContentBoxSize: m(), borderBoxSize: m(), contentBoxSize: m(), contentRect: new o(0, 0, 0, 0) }),
        v = function (t, e) {
            if (void 0 === e && (e = !1), u.has(t) && !e) return u.get(t);
            if (h(t)) return u.set(t, C), C;
            var i = getComputedStyle(t), s = a(t) && t.ownerSVGElement && t.getBBox(),
                n = !W && "border-box" === i.boxSizing, c = g.test(i.writingMode || ""),
                l = !s && d.test(i.overflowY || ""), v = !s && d.test(i.overflowX || ""), F = s ? 0 : p(i.paddingTop),
                V = s ? 0 : p(i.paddingRight), w = s ? 0 : p(i.paddingBottom), Y = s ? 0 : p(i.paddingLeft),
                y = s ? 0 : p(i.borderTopWidth), L = s ? 0 : p(i.borderRightWidth), A = s ? 0 : p(i.borderBottomWidth),
                b = Y + V, S = F + w, E = (s ? 0 : p(i.borderLeftWidth)) + L, K = y + A,
                x = v ? t.offsetHeight - K - t.clientHeight : 0, I = l ? t.offsetWidth - E - t.clientWidth : 0,
                B = n ? b + E : 0, f = n ? S + K : 0, J = s ? s.width : p(i.width) - B - I,
                k = s ? s.height : p(i.height) - f - x, D = J + b + I + E, q = k + S + x + K, Z = r({
            ...
            var r = v(e, s), n = r.borderBoxSize, o = r.contentBoxSize, a = r.devicePixelContentBoxSize;
            switch (i) {
            ...
            var e = v(t);
            this.target = t, this.contentRect = e.contentRect, this.borderBoxSize = r([e.borderBoxSize]), this.contentBoxSize = r([e.contentBoxSize]), this.devicePixelContentBoxSize = r([e.devicePixelContentBoxSize])
        }, w = function (t) {
            if (h(t)) return 1 / 0;
            ...
            e.forEach((function (e) {
                if (0 !== e.activeTargets.length) {
                    ...
                    e.activeTargets.forEach((function (e) {
                        var i = new V(e.target), r = w(e.target);
                        s.push(i), e.lastReportedSize = F(e.target, e.observedBox), r < t && (t = r)
                    })), i.push((function () {
            ...
            })) && ("function" == typeof ErrorEvent ? t = new ErrorEvent("error", { message: i }) : ((t = document.createEvent("Event")).initEvent("error", !1, !1), t.message = i), window.dispatchEvent(t)), s > 0
        }, A = [], b = function (t) {
            if (!s) {
                var e = 0, i = document.createTextNode("");
                new MutationObserver((function () {
                    return A.splice(0).forEach((function (t) {
                        return t()
                    }))
                })).observe(i, { characterData: !0 }), s = function () {
                    i.textContent = "".concat(e ? e-- : e++)
                }
            }
            A.push(t), s()
        }, S = 0, E = { attributes: !0, characterData: !0, childList: !0, subtree: !0 },
        K = ["resize", "load", "transitionend", "animationend", "animationstart", "animationiteration", "keyup", "keydown", "mouseup", "mousedown", "mouseover", "mouseout", "blur", "focus"],
        x = function (t) {
            ...
            return t.prototype.run = function (t) {
                ...
                var t = this;
                this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), K.forEach((function (e) {
                    return l.addEventListener(e, t.listener, !0)
                })))
            }, t.prototype.stop = function () {
                var t = this;
                this.stopped || (this.observer && this.observer.disconnect(), K.forEach((function (e) {
            ...
            return e.prototype.isActive = function () {
                ...
                return t = this.target, a(t) || function (t) {
                    switch (t.tagName) {
                        case "INPUT":
            ...
            return t.connect = function (t, e) {
                ...
                var r = D.get(t), n = 0 === r.observationTargets.length;
                q(r.observationTargets, i) < 0 && (n && e.push(r), r.observationTargets.push(new J(i, s && s.box)), f(1), B.schedule())
            }, t.unobserve = function (t, i) {
                var s = D.get(t), r = q(s.observationTargets, i), n = 1 === s.observationTargets.length;
                r >= 0 && (n && e.splice(e.indexOf(s), 1), s.observationTargets.splice(r, 1), f(-1))
            }, t.disconnect = function (t) {
                var e = this, i = D.get(t);
    ...
    var N = {
        chisato: {
            ...
            initialState: { i: .08, s: .1, d: .99, r: 1, y: 40, t: 0, w: 0 }
        }, takina: {
            ...
            initialState: { i: .08, s: .1, d: .988, r: 12, y: 2, t: 0, w: 0 }
        }
    };
    ...
    function M(t, e) {
        ...
        return R(i) && R(s) ? (Object.keys(s).forEach((t => {
            R(s[t]) ? (R(i[t]) || (i[t] = {}), i[t] = M(i[t], s[t])) : i[t] = s[t]
        })), i) : i
    }
    ...
    function G(t) {
        ...
        return function (...s) {
            var r;
            e = s, null === i && (i = requestAnimationFrame((r = this, () => {
                i = null, t.apply(r, e)
            })))
        }
    }
    ...
    class X {
        constructor(t = {}) {
            this._lastRunUnix = Date.now(), this._frameUnix = 1e3 / 60, this._running = !0, this._magicForceTimeout = 0, this._magicForceEnabled = !1, this._resizeObserver = null, this._updateLimit = t => {
                let e = t / 5;
                e < 30 ? e = 30 : e > 60 && (e = 60);
                const i = t / 4, s = -i;
                this._limit = { maxR: e, maxY: i, minY: s }
            }, this._updateSize = t => {
                this._options.size = t, this._imageSize = this._options.size / 1.25, this._canvasSize = 1.5 * this._options.size, this._domApp.style.width = `${t}px`, this._domApp.style.height = `${t}px`, this._domCanvas.style.width = `${this._canvasSize}px`, this._domCanvas.style.height = `${this._canvasSize}px`;
                ...
                const r = Math.PI / 180 * t, n = Math.cos(r), o = Math.sin(r);
                return { nx: o * e + n * i - o * s, ny: n * e - n * s - o * i }
            }, this._draw = () => {
                const { r: t, y: e } = this._state, { size: i, controls: s, stroke: r } = this._options, n = this._domImage,
                    o = this._imageSize, a = this._domCanvasCtx, h = 1 * t;
                if (n.style.transform = `rotate(${t}deg) translateX(${h}px) translateY(${e}px)`, a.clearRect(0, 0, this._canvasSize, this._canvasSize), a.save(), a.translate(this._canvasSize / 2, i + (this._canvasSize - i) / 2), a.strokeStyle = r.color, a.lineWidth = r.width, a.lineCap = "round", this._options.rod && a.beginPath(), s ? a.moveTo(0, -10) : a.moveTo(0, 10), this._options.rod) {
                    const s = i - o / 2, { nx: r, ny: n } = this._calcCenterPoint(t, s, h, e);
                ...
                const { d: o, i: a } = this._state, h = Date.now();
                let c = a;
                const l = h - this._lastRunUnix;
                l < 16 && (c = a / this._frameUnix * l), this._lastRunUnix = h, n = n - 2 * i - t, i += n * c * 1.2, this._state.w = n * o, this._state.r = i, r -= 2 * s, s += r * c * 2, this._state.t = r * o, this._state.y = s, Math.max(Math.abs(this._state.w), Math.abs(this._state.r), Math.abs(this._state.t), Math.abs(this._state.y)) < e ? this._running = !1 : (this._draw(), requestAnimationFrame(this._run))
            }, this._move = (t, e) => {
                const { maxR: i, maxY: s, minY: r } = this._limit;
                let n = t * this._state.s;
                n = Math.max(-i, n), n = Math.min(i, n), e = e * this._state.s * 2, e = Math.max(r, e), e = Math.min(s, e), this._state.r = n, this._state.y = e, this._state.w = 0, this._state.t = 0, this._draw()
            }, this._onMouseDown = t => {
                t.preventDefault(), this._running = !1;
                const { pageY: e } = t, i = e;
                this._state.w = 0, this._state.t = 0;
                const s = t => {
                    const e = this._domMain.getBoundingClientRect(), s = e.left + e.width / 2, { pageX: r, pageY: n } = t,
                        o = r - s, a = n - i;
                    this._move(o, a)
                }, r = () => {
                    document.removeEventListener("mousemove", s), document.removeEventListener("mouseup", r), this._running = !0, requestAnimationFrame(this._run)
                };
                ...
                const { pageY: e } = t.touches[0], i = e;
                this._state.w = 0, this._state.t = 0;
                const s = t => {
                    if (!t.touches[0]) return;
                    const e = this._domMain.getBoundingClientRect(), s = e.left + e.width / 2, {
                        pageX: r,
                        pageY: n
                    } = t.touches[0], o = r - s, a = n - i;
                    this._move(o, a)
                }, r = () => {
                    document.removeEventListener("touchmove", s), document.removeEventListener("touchend", r), this._running = !0, requestAnimationFrame(this._run)
                };
                document.addEventListener("touchmove", s), document.addEventListener("touchend", r)
            }, this._magicForce = () => {
                if (Math.random() < .1) {
                    const t = Object.keys(T), e = t[Math.floor(Math.random() * t.length)];
                    this.setCharacter(e)
                } else this._state.t = this._state.t + 150 * (Math.random() - .5), this._state.w = this._state.w + 200 * (Math.random() - .5);
                this._running || (this._running = !0, requestAnimationFrame(this._run)), this._magicForceTimeout = window.setTimeout(this._magicForce, 3e3 * Math.random() + 2e3)
            }, this.triggerAutoMode = () => {
                this._magicForceEnabled = !this._magicForceEnabled;
                const t = this._domCtrlMagic.querySelector("svg");
                this._magicForceEnabled ? t.classList.add("sakana-widget-icon--rotate") : t.classList.remove("sakana-widget-icon--rotate"), clearTimeout(this._magicForceTimeout), this._magicForceEnabled && (this._magicForceTimeout = window.setTimeout(this._magicForce, 1e3 * Math.random() + 500))
            }, this.setState = t => (this._state || (this._state = {}), this._state = M(this._state, U(t)), this), this.setCharacter = t => {
                const e = T[t];
                if (!e) throw new Error(`invalid character ${t}`);
                return this._char = t, this._image = e.image, this.setState(e.initialState), this._domImage && (this._domImage.style.backgroundImage = `url('${this._image}')`), this
            }, this.nextCharacter = () => {
                const t = Object.keys(X.getCharacters()).sort(), e = t.indexOf(this._char), i = t[(e + 1) % t.length];
                ...
                let e;
                if (e = "string" == typeof t ? document.querySelector(t) : t, !e) throw new Error("Invalid mounting element");
                const i = e.parentNode;
                if (!i) throw new Error("Invalid mounting element parent");
                this._options.draggable && (this._domImage.addEventListener("mousedown", this._onMouseDown), this._domImage.addEventListener("touchstart", this._onTouchStart)), this._domCtrlPerson.addEventListener("click", this.nextCharacter), this._domCtrlMagic.addEventListener("click", this.triggerAutoMode), this._domCtrlClose.addEventListener("click", this.unmount), this._options.autoFit && (this._onResize(this._domWrapper.getBoundingClientRect()), this._resizeObserver = new O(G((t => {
                    t && t[0] && this._onResize(t[0].contentRect)
                }))), this._resizeObserver.observe(this._domWrapper));
                const s = e.cloneNode(!1);
                return s.appendChild(this._domWrapper), i.replaceChild(s, e), requestAnimationFrame(this._run), this
            }, this.unmount = () => {
                this._domImage.removeEventListener("mousedown", this._onMouseDown), this._domImage.removeEventListener("touchstart", this._onTouchStart), this._domCtrlPerson.removeEventListener("click", this.nextCharacter), this._domCtrlMagic.removeEventListener("click", this.triggerAutoMode), this._domCtrlClose.removeEventListener("click", this.unmount), this._resizeObserver && this._resizeObserver.disconnect();
            ...
            }, null == T && Q(), this._options = U(z), this._options = M(this._options, t), this.setCharacter(this._options.character), this._updateDom(), this._updateSize(this._options.size), this._updateLimit(this._options.size)
        }
    }
    ...
    return X.getCharacter = t => {
        ...
        const e = T[t];
        return e ? U(e) : null
    }, X.getCharacters = () => (null == T && Q(), U(T)), X.registerCharacter = (t, e) => {
        const i = U(e);
        let s = i.initialState.i;
        s = Math.min(.5, Math.max(0, s)), i.initialState.i = s, T[t] = i
    }, X
}));