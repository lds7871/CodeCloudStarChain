...
public interface SysArticleMapper extends BaseMapper<SysArticle> {
     ...
     * @return
     */
    IPage<ArticleListVo> selectPageList(@Param("page") Page<Object> page,
            @Param("query") ArticleQueryDto articleQueryDto);
     ...
     * @return
     */
    List<ArticleListVo> getCarouselArticles();
     ...
     * @return
     */
    List<ArticleListVo> getRecommendArticles();
}
